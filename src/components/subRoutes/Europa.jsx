    ...
    <div className="flex justify-evenly items-start">
      ...
      <div className="w-[20%]">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-lg md:text-lg lg:text-2em lg:text-start font-light lg:tracking-wide lg:leading-loose mb-10 w-full">
          ...
          <div className="flex justify-start gap-20 uppercase tracking-widest">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-2xl font-bellefair">{europaData.distance}</p>
            </div>
            <div className="flex flex-col gap-2">
              <p className="text-md font-light text-slate-300">
                Est. travel time
              </p>
              <p className="text-2xl font-bellefair">{europaData.travel}</p>
            </div>
          </div>
        </div>
      </div>
